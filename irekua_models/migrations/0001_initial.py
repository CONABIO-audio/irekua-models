    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='irekua_database.EventType')),
                ...
                ('labels', models.ManyToManyField(to='irekua_database.Term')),
                ('model_version', models.ForeignKey(db_column='model_version_id', on_delete=django.db.models.deletion.PROTECT, to='irekua_models.ModelVersion')),
